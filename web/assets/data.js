...
window.LIBRARY = [
  ...
  { key: "01", src: "images/01-skogsalva-white-lace.jpg", crop: [0, 12, 100, 75], concept: "Skogsälva",
    ...
    note: "Wings against dark bark. Real greenery crown, not plastic. Summer green, so here for the wings, not the season." },
  ...
  { key: "10", src: "images/10-than-tien-jungle.jpg", crop: [0, 36, 100, 45], concept: "Skogsrå",
    title: "THẦN TIÊN, jungle and crown", source: "Facebook · Kawai Studio",
  ...
  { key: "20", src: "images/20-golden-gown-godrays.jpg", crop: [0, 0, 100, 100], concept: "Höstdrottning",
    ...
    note: "Reads AI, so treat it as a lighting diagram, not a promise. Hanging leaf curtain plus a hazed backlight is buildable indoors." },
  ...
  { key: "23", src: "images/23-newborn-bucket-rust.jpg", crop: [0, 0, 100, 100], concept: "Nyfödd",
    ...
    note: "Dark wood, gold leaves, one soft source overhead. A bucket, a wrap and a fur, and the entire set costs under 500 kr." },
  ...
  { key: "09", src: "images/09-rose-garden-haze.jpg", crop: [0, 12, 100, 51], concept: "Rosenrus",
    ...
    note: "Diffusion filter and a flare. Roses are done by October, so swap to rosehips and rowan, which are more Swedish anyway." },
